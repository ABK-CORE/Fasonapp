...
namespace WebApi.Controllers
{
    ...
    [ApiController]
    public class FasonIslemController : ControllerBase
    {
        private readonly IConfiguration _configuration;
        private readonly Processor _processor;

        public FasonIslemController(IConfiguration configuration, Processor processor)
        {
            _configuration = configuration;
            _processor = processor;
        }

        [HttpGet("GetFasonIslemler")]
        public IActionResult GetFasonIslemler()
        {
            try
            {
                ...
                {
                    var data = con.Query("sp_GetFasonIsler",
