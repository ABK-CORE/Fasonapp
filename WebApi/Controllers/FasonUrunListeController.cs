...
namespace WebApi.Controllers
{
    ...
    [ApiController]
    public class FasonUrunListeController : ControllerBase
    {
        private readonly IConfiguration _configuration;
        private readonly Processor _processor;

        public FasonUrunListeController(IConfiguration configuration, Processor processor)
        {
            _configuration = configuration;
            _processor = processor;
        }

        [HttpGet("GetFasonUrunListe")]
        public IActionResult GetFasonUrunListe()
        {
            try
            {
                ...
                {
                    var data = con.Query("sp_StokListelefasonlar",
